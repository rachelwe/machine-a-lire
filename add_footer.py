def vertical(formatted_filename, output_file, metadatas):
	...
	output_file.write('<div class="ticket">\n<p>Un ticket-voyage proposé par La Bibilothèque patrimoniale numérique d\'Alca en nouvelle-Aquitaine. Pour plus de découvertes et pour télécharger des livres numériques gratuitement et librement : <u>alca-nouvelle-aquitaine.fr/fr/catalogue-numerique-patrimonial</u>\n</div>')
	output_file.write('<div class="italic">\n<p>Ticket-voyage à conserver - Ne pas jeter sur la voie publique</p>\n</div>')
	...
	output_file.write('<div class="mentions">\n<p>Agence livre, cinéma et audiovisuel de la Région Nouvelle-Aquitaine, ALCA accompagne les professionnels de l’image et de l’écrit dans toutes les étapes de leur parcours et de leurs projets, de la création à la diffusion d’œuvres.</p><p>Interface privilégiée entre la stratégie culturelle de la Région Nouvelle-Aquitaine, la Drac et les professionnels concernés, ALCA organise, depuis ses sites d’Angoulême, de Bordeaux, de Limoges et de Poitiers, le soutien aux industries du livre, du cinéma et de l’audiovisuel. Les actions portées par ALCA visent un équilibre géographique en direction des industries culturelles de la région et le rayonnement de ses acteurs, en France et à l’international.</p>\n</div>')
	output_file.write('<div class="mentions">\n<p>La Makina Bellét est un dispositif librement inspiré par "l\'Exprimante" de Lectura Plus</p>\n</div>')
